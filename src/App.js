  ...
  return (
    ...
    <Navbar/>
      <Routes>
        ...
        <Route exact path="/pages/OrderPage" element={<OrderPage />} />
        <Route exact path="/pages/WishList" element={<WishList />} />
        <Route exact path="/pages/CreateCategory" element={<CreateCategory />} />
        <Route exact path="/pages/UpdateProduct" element={<UpdateProduct />} />
      </Routes>
      <ToastContainer />
    </>
  );
