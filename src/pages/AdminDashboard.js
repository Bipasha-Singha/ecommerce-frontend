            ...
            <div className="dashboard-row">
              <div className="dashboard-col-3 bg-light">
                <ul className="dashboard-list-group">
                  ...
                  <Link to="/pages/CreateCategory">
                    <button className="dashboard-button"> Create Category</button>
                  </Link>
                  <Link to="/pages/UpdateProduct">
                    <button className="dashboard-button"> Delete Product</button>
                  </Link>
                </ul>
              </div>
            </div>
